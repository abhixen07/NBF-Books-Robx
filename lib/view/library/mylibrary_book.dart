...
class MyLibraryBookPage extends StatelessWidget {
  final VoidCallback? goBackToMainLibrary;
  final Function(int index)? onSubPageChange1;
  const MyLibraryBookPage({super.key, this.goBackToMainLibrary,this.onSubPageChange1});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(onPressed: goBackToMainLibrary, icon: const Icon(Icons.arrow_back_ios_outlined,color: btn2Color,)),
        backgroundColor: whiteColor,
      ),
      body: Padding(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              TextButton.icon(
                                onPressed: () => onSubPageChange1?.call(4),
