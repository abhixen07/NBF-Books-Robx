...
import 'package:nbf_bookpublications_app/view/pdf_reader.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Home', style: TextStyle(fontWeight: FontWeight.w700, color: blackColor)),
        centerTitle: false,
        backgroundColor: whiteColor,
        actions: [
          Padding(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          sectionHeader("Best Selling books"),
          const SizedBox(height: 10),
